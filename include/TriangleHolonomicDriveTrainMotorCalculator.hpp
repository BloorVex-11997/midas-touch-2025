...
|m1|    | sin(theta1 + 90)   cos(theta1 + 90)    1 |   |ax|
|m2| =  | sin(theta2 + 90)   cos(theta2 + 90)    1 | * |ay|
|m3|    | sin(theta3 + 90)   cos(theta3 + 90)    1 |   |r |
...
double motorMatrix[3] = {0,0,0};


//matrix for calculating motor vectors
double TransformationMatrix[3][3] = {
    {sin(rad(THETA1 + 90.0)), cos(rad(THETA1 + 90.0)), 1},
    {sin(rad(THETA2 + 90.0)), cos(rad(THETA2 + 90.0)), 1},
    {sin(rad(THETA3 + 90.0)), cos(rad(THETA3 + 90.0)), 1}
                                    };
...
void updateMatrix(int omega)
    {
    TransformationMatrix[0][0] = sin(rad(THETA1 + 90.0 + omega));
    TransformationMatrix[0][1] = cos(rad(THETA1 + 90.0 + omega));
    TransformationMatrix[1][0] = sin(rad(THETA2 + 90.0 + omega));
    TransformationMatrix[1][1] = cos(rad(THETA2 + 90.0 + omega));
    TransformationMatrix[2][0] = sin(rad(THETA3 + 90.0 + omega));
    TransformationMatrix[2][1] = cos(rad(THETA3 + 90.0 + omega));
    }

//calculates matrix equation for m1,m2,m3
void calculateMatrix(int ax, int ay, int r)
    {
